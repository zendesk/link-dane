...
If everything worked, you should have Link-Dane open and running in your browser. You won't see any facilities listed in search, so you'll want to add one in the admin interface. First, create a new user in the Parse interface, then:
...
We use http://fontello.com to generate an icon bundle. [Here's a guide on how to add or change icons](https://github.com/zendesk/link-dane/blob/master/docs/ICONS.md).
...
1. Click `Start...`
1. Open the Android browser and visit Link-Dane.
...
2. Add your Mailgun domain and API key to the `.env.xxx` files (see [example .env.xxx file](https://github.com/zendesk/link-dane/blob/master/.env.example))
